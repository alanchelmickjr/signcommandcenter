...
# Generate configuration file for front-end
echo "📝 Creating configuration file for dynamic ports..."
cat > config.js << EOF
// Auto-generated configuration file - DO NOT EDIT MANUALLY
// Generated by start.sh on $(date)
window.ASL_CONFIG = {
    AI_SERVER_URL: 'http://localhost:$AI_PORT',
    ASL_SERVER_URL: 'http://localhost:$ASL_PORT',
    GUN_RELAY_URL: 'http://localhost:$GUN_PORT/gun',
